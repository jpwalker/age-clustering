...
def cast(d, typ):
    try:
        if typ == 0 or typ == 1 or typ == 2 or typ == 3 or typ == 4 or typ == 5  or typ == 6 or \
        typ == 10 or typ == 15 or typ == 16 or typ == 17 or typ == 20 or typ == 21 or typ == 22 \
        or typ == 23 or typ == 24:
            return int(d)
        else:
            return float(d)
...
#def get_merger_tree(haloid, lastprogenitorid, snapnum):   
